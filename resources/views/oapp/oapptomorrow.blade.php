...
<body class="no-skin" style="font-family:'Sarabun'">
	...
	//WHERE o.hn IN (SELECT hn FROM smarthos2.patientusers) AND o.nextdate = DATE_FORMAT(DATE_ADD(NOW(),INTERVAL 0 DAY),'%Y-%m-%d')";
        ...
        LEFT OUTER JOIN patient p ON p.hn = o.hn 
			...
			foreach ($result AS $data) {
				...
				$access_token = 'qOUJQH7nfitZFH0038OwxIP8KR/pFyapst8GXVU9LRXU1pStX9Fb+ZgSTMdc2S1Us8Vnl16riyl766lFwsuqdRNClH4DK3HxiollknuelONUTdT5XNf+WfWnK9RxDka+8YmEpuUKP88Dv/VJbRDzIAdB04t89/1O/w1cDnyilFU=';
				$pushID = $idline;
        $curl = curl_init();
  ...
  "hero": {
    "type": "image",
    "url": "https://restful.tphcp.go.th/appointment-tphcp6.jpg",
    "size": "full",
    ...
    "contents": [
      {
        ...
        "contents": [
          ...
          {
            "type": "text",
            "text": "อย่าลืมนะ...พรุ่งนี้คุณมีนัด",
            "color": "#FF0000",
            "margin": "md",
            "weight": "bold",
            "size": "lg"
