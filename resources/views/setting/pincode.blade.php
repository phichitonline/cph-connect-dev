...
<div class="page-content header-clear-small">
    ...
    <div class="card card-style">
        <div class="d-flex content">
            <div class="flex-grow-1">
                <div>
                    <h1 class="font-700 mb-1">TEST</h1>
    ...
    <div class="card card-style">
        ...
        <a href="#" data-menu="login-pin-register2" data-timed-ad="0" data-auto-show-ad="0" class="btn btn-l btn-full rounded-s shadow-xl text-uppercase font-900 bg-highlight mr-3 ml-3 mb-4">PIN code confirm</a>
    ...
    <div id="login-pin-register2" class="menu menu-box-modal menu-box-detached round-large" data-menu-width="100vw" data-menu-height="100vh" data-menu-effect="menu-over">
        <div class="card bg-17" data-card-height="100vh">
            ...
            <div class="card-center text-center">
                ...
                <form name="loginpin" id="loginpin" action="{{route('pincode')}}" method="POST">
                    <input type="hidden" name="pincode1" value="">
