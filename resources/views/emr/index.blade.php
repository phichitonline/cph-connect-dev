            ...
            <div class="list-group list-custom-large list-icon-0">
                ...
                <a href="{{ route('emr.show', $data->vn) }}">
                    @if ($data->an !== NULL)
                        ...
                        <span class="color-red2-dark">{{ DateThaiShort($data->vstdate) }} เวลา {{ TimeThai($data->vsttime) }} น. (ผู้ป่วยใน)</span>
                    ...
                    @else
                        @if (strpos($data->visitdiag, $emr_checkup_icd10) === FALSE)
                            ...
                            <span>{{ DateThaiShort($data->vstdate) }} เวลา {{ TimeThai($data->vsttime) }} น.</span>
