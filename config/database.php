    ...
    */
    ...
    'connections' => [
        ...
        'mysql_covid66' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST3', '203.157.220.245'),
            'port' => env('DB_PORT', '3306'),
            'database' => env('DB_DATABASE3', 'covid-66'),
        ...
        'mysql_hos' => [
            ...
            'password' => env('DB_PASSWORD1', 'ghUD2gES'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8',
            'collation' => 'utf8_unicode_ci',
            'prefix' => '',
        ...
        'mysql' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST2', '200.200.200.12'),
            'port' => env('DB_PORT', '3306'),
            'database' => env('DB_DATABASE2', 'cphconnect'),
